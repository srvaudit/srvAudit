    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container-fluid" v-if="user">
            <div class="navbar-header">
                ...
                <div class="nav-hint pull-right visible-ms" style="cursor:pointer;" data-toggle="collapse" data-target="#spark-navbar-collapse">Menu</div>
                <div class="nav-hint pull-right visible-xs" style="cursor:pointer;" data-toggle="collapse" data-target="#spark-navbar-collapse">Menu</div>
